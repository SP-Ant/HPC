...
public class SchedulerAssignmentImpl implements SchedulerAssignment {
    ...
    public SchedulerAssignmentImpl(String topologyId, Map<ExecutorDetails, WorkerSlot> executorToSlot,
       ...
       // System.out.println("..Ant Colony.   SchedulerAssignmentImpl  ..SchedulerAssignmentImpl. 00 "+ this.topologyId  );
        if (executorToSlot != null) {
          //  System.out.println("..Ant Colony.   SchedulerAssignmentImpl  ..SchedulerAssignmentImpl. 11 "  );
        ...
        if (resources != null) {
           // System.out.println("..Ant Colony.   SchedulerAssignmentImpl  ..SchedulerAssignmentImpl. 22 "  );
        ...
        if (nodeIdToTotalSharedOffHeap != null) {
           // System.out.println("..Ant Colony.   SchedulerAssignmentImpl  ..SchedulerAssignmentImpl. 33 "  );
    ...
    public Set<WorkerSlot> getSlots() {
       ...
       // System.out.println("..Ant Colony.   SchedulerAssignmentImpl  ..getSlots. "  );
    ...
    public Map<ExecutorDetails, WorkerSlot> getExecutorToSlot() {
        //System.out.println("..Ant Colony.   SchedulerAssignmentImpl  ..getExecutorToSlot. "  );
